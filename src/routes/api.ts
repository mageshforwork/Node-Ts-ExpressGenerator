...
import upload, { upload_none } from "@src/routes/middleware/UploadsMiddleware";
...
SuperRouter.post(Paths.Auth.Register, upload.uploadFile, SuperAuthRoutes.add); // Register one admin
